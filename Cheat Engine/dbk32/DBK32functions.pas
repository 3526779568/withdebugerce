...
resourcestring
  ...
  rsYouAreMissingTheDriver = 'You are missing the driver. Try reinstalling DDY Engine, and try to disable your anti-virus before doing so.';
  ...
  rsTheDriverThatIsCurrentlyLoaded = 'The driver that is currently loaded belongs to a different version of DDY Engine. Please unload this driver or reboot.';
  ...
  rsPleaseRunThe64BitVersionOfCE = 'Please run the 64-bit version of DDY Engine';
    ...
    //  usealternatedebugmethod:=false;
      ...
      try
        ...
        begin
          ...
          servicename:='DDYDRIVER68';
          processeventname:='DDYProcList60';
          threadeventname:='DDYThreadList60';
          if iswow64 then
            sysfile:='ddy64.sys'
          else
            sysfile:='ddy32.sys';
