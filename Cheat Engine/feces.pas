unit feces;
//friends endorsing DDY Engine system
...
resourcestring
  ...
  rsSelectYourCheatEngineSignatureFile = 'Select your DDY Engine signature '
    +'file';
  rsCheatEngineSignatureFiles = 'DDY Engine signature files';
  ...
  rsInvalidPublicKey = 'The provided public key is invalid(Not signed by the '
    +'DDY Engine guy). Remove the signature section to load this table';
  ...
  rsFailedToLoadCheatEnginePublicKey = 'Failed to load DDY Engine public key';
