...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\DDY Engine\DissectData',true) then
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\DDY Engine\DissectData\Font',true) then
...
begin
  ...
  try
    ...
    begin
      ...
      if Reg.OpenKey('\Software\DDY Engine\DissectData\Font',false) then
      begin
