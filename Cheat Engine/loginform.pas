...
begin
     ...
     status := DeviceIoControl(hdevice,PROCESS_DebugActiveProcess, @data,sizeof(InputOutputData64), @data , sizeof(InputOutputData64),retsize,nil);
     if status=0 then
       result := false
     else
       result:= true;
