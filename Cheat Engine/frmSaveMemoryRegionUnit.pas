...
resourcestring
  ...
  rsNoStartAddress = 'If you don''t include the header data you''ll have to specify the startaddress yourself when loading the file(That means DDY Engine wont fill in the '
