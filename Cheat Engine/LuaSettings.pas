...
type
  TLuaSettings=class    //A wrapper for the registry object to make access to the DDY Engine settings easier and uniform
  private
    freg: Tregistry;
    fpath: string;
...
begin
  ...
  if freg.OpenKey('\Software\DDY Engine\'+v, true) then
    fpath:=v;
end;
...
begin
  ...
  freg.OpenKey('\Software\DDY Engine',true);
