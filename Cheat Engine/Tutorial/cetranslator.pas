...
var
  ...
  begin
    ...
    begin
      ...
      Result := Application.Location+'languages' + DirectorySeparator + LangID + DirectorySeparator + 'tutorial'+LCEXT;
      if FileExistsUTF8(Result) then exit;

      Result := Application.Location+'languages' + DirectorySeparator + LangID + DirectorySeparator + 'tutorial-x86_64'+LCEXT;
      if FileExistsUTF8(Result) then exit;

      Result := Application.Location+'languages' + DirectorySeparator + LangID + DirectorySeparator + 'tutorial-i386'+LCEXT;
      if FileExistsUTF8(Result) then exit;
