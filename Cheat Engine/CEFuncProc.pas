...
//DDY Engine regular WONT look at this
...
begin
  ...
  try
    ...
    try
      ...
      if Reg.OpenKey('\Software\DDY Engine\Window Positions '+inttostr(screen.PixelsPerInch),false) or Reg.OpenKey('\Software\DDY Engine\Window Positions',false) then
      begin
        s:=form.Name;
        s:=s+rsPosition;
...
begin
  ...
  begin
    ...
    try
      ...
      if Reg.OpenKey('\Software\DDY Engine\Window Positions '+inttostr(screen.PixelsPerInch),true) then
      begin
