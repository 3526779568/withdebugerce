...
resourcestring
  ...
  strCantLoadFilepatcher='The file patcher can''t be loaded by DDY Engine!';
  strNotACETrainer='This is not a trainer made by DDY Engine (If it is a trainer at all!)';
  strUnknownTrainerVersion='This version of DDY Engine doesn''t know how to read this trainer! Trainerversion=';
  ...
  rsOSThereIsANewerVersionifCheatEngineOutEtc = 'There is a newer version of DDY Engine out. It''s recommended to use that version instead';
    ...
    begin
      ...
      begin
        ...
        try
          ...
          if Reg.OpenKey('\Software\DDY Engine',false) then   //fill it from the registry (in case it's loaded before the settings are loaded)
          begin
