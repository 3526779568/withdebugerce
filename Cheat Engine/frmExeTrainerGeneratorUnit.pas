...
begin
  ...
  begin
    ...
    MainForm.frmLuaTableScript.assemblescreen.Lines.Insert(2, '  messageDialog(''Please install DDY Engine ''..RequiredCEVersion, mtError, mbOK)');
        ...
        begin
          ...
          begin
            ...
            if cbvehdebug.checked then
              addfile(cheatenginedir+'32ddyveh.dll');

            if cbKernelDebug.checked then
            begin
              addfile(cheatenginedir+'ddy32.sys');
              addfile(cheatenginedir+'ddy64.sys');
          ...
          begin
            ...
            if cbvehdebug.checked then
              addfile(cheatenginedir+'64ddyveh.dll');
