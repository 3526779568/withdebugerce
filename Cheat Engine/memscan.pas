...
resourcestring
  ...
  rsMSTheScanWasForcedToTerminateSubsequentScansMayNotFunctionProperlyEtc = 'The scan was forced to terminate. Subsequent scans may not function properly. It''s recommended to restart DDY Engine';
  rsThread = 'thread ';
//===============Local functions================//
...
begin
  ...
  fScanResultFolder:=usedtempdir+'DDY Engine'+pathdelim;
...
begin
  ...
  begin
    try
      ...
      if FindFirst(usedtempdir+'DDY Engine\{*}',  faDirectory , info)=0 then
      begin
        repeat
          ...
          begin
            ...
            begin
              ...
              f:=usedtempdir+'DDY Engine\'+info.name;
